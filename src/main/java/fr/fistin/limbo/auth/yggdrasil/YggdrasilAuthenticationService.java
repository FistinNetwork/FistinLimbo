package fr.fistin.limbo.auth.yggdrasil;

import com.google.gson.*;
import fr.fistin.limbo.auth.HttpAuthenticationService;
import fr.fistin.limbo.auth.exception.AuthenticationException;
import fr.fistin.limbo.auth.exception.AuthenticationUnavailableException;
import fr.fistin.limbo.auth.exception.InvalidCredentialsException;
import fr.fistin.limbo.auth.exception.UserMigratedException;
import fr.fistin.limbo.auth.profile.GameProfile;
import fr.fistin.limbo.auth.profile.property.PropertyMap;
import fr.fistin.limbo.auth.yggdrasil.response.YggdrasilResponse;
